...
// BluetoothGatt
// This right here is the string that prints out the data we're looking for
// modify and see if anything changes
...
// This is the function that converts the Characteristic which is of a type ByteArray
// this function turns that byte array into a string able to be printed on the timberlog
//
fun ByteArray.toHexString(): String =
    joinToString(separator = " ", prefix = "Hex: ") { String.format("%02x", it) }
    //joinToString(separator = " ", prefix = "Decimal: ") { String.format("%d", it) }
